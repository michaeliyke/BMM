...
import { toggleHighlightedClass, toggleSelectedClass, resetSelections, sortedCategories } from "../../../utils/common";
...
export function DisplayCategoryTags({ props }: DCPProps) {
    const {
